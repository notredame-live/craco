        ...
        <div className="dark relative bg-gray-800 py-10 px-8 md:py-16 md:px-12">
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
              <h3 className="h3 font-red-hat-display text-gray-100">any support is GLADLY appreciated</h3>
            </div>

            {/* CTA form */}
            <form className="w-full lg:w-1/2">
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none">
                <input type="tel" className="form-input w-full mb-2 sm:mb-0 sm:mr-2" placeholder="$ ammount here" aria-label="Phone number" />
